...
public class Game {
	...
	public int playRound(Player player, DiceValue pick, int bet ) {		
		if (player == null) throw new IllegalArgumentException("Player cannot be null.");//giving condition 
		if (pick == null) throw new IllegalArgumentException("Pick cannot be negative.");// condition pick cant be negative
		if (bet < 0) throw new IllegalArgumentException("Bet cannot be negative.");// condition bet cannot be negative
